                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Job
                            Title</label>
                        <input type="text" id="title" name="title" placeholder="e.g., Graphic Designer"
                            value="{{ old('title') }}"
                    ...
                    <div>
                        ...
                        <input type="number" id="salary" name="salary" placeholder="e.g., 50000.00"
                    ...
                    <div>
                        ...
                        <select id="job_type" name="job_type"
                            ...
                            <option value="part_time" {{ old('job_type') == 'part_time' ? 'selected' : '' }}>Part Time
                            </option>
