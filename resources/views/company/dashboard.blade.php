<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-base text-gray-500 dark:text-gray-400">Create, edit, delete, and view your job
                        postings.</p>
                </div>
            ...
            <div
                ...
                <div>
                    ...
                    <p class="text-base text-gray-500 dark:text-gray-400">View applications from job seekers for your
                        posted jobs.</p>
                    <div class="mt-4">
                        <ul class="space-y-2">
                ...
                <a href="{{ route('applications') }}" class="text-blue-500 mt-auto inline-block">View All
                    Applications</a>
            </div>
            ...
            <div
                ...
                <a href="#" class="text-blue-500 mt-auto inline-block">View All
                    Notifications</a>
            </div>
        </div>
        ...
        <div
            class="w-full p-6 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 mb-6">
            <h2 class="text-xl font-semibold mb-4">Analytics</h2>
            <p class="text-base text-gray-500 dark:text-gray-400">Get insights into your job postings and applications.
            </p>
